...
renderNewContact :: Contact -> [Error] -> T.Text
renderNewContact contact errs = renderHtml $ do
  docTypeHtml $
    html $ do
      body $ do
        form ! HA.action "/contacts/new" ! HA.method "post" $ do
          fieldset $ do
            ...
            p $ do
              ...
              -- span ! HA.class_ "error" $ toHtml (email contact)
            ...
            p $ do
              ...
              -- span ! HA.class_ "error" $ toHtml (firstN contact)
            ...
            p $ do
              ...
              -- span ! HA.class_ "error" $ toHtml (lastN contact)
            ...
            p $ do
              ...
              -- span ! HA.class_ "error" $ toHtml (phone contact)
